...
def load_word_match_ratio_magic_train():
    return pd.read_csv(q1_q2_word_match_ratio_train_fp, index_col='id')


def load_word_match_ratio_magic_test():
    return pd.read_csv(q1_q2_word_match_ratio_test_fp, index_col='test_id')
...
def load_train_all_xgb():
    train_df = pd.concat([
        ...
        load_word_match_ratio_magic_train()
...
name='try_word_match_ratio_magic_light'
