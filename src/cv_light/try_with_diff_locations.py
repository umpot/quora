...
def load_diff_loc_train():
    return pd.read_csv(diff_loc_train_fp, index_col='id')
def load_diff_loc_test():
    return pd.read_csv(diff_loc_test_fp, index_col='test_id')
######################################################################################
######################################################################################
######################################################################################
######################################################################################
