...
def perform_xgb_cv(name, stops, max_features, ngram_range,analyzer):
    seed = 42
    ...
    c=create_vectorizer(df, stops, max_features, ngram_range,analyzer)
    ...
    update_df.to_csv('{}.csv'.format(name), index_label='id')
