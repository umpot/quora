...
######################################################################################
######################################################################################
upper_stops = {'the', 'is', 'a', 'to', 'in', 'of', 'do', 'are', 'and', 'for', 'you', 'can', 'best', 'it', 'my', 'on',
               'does', 'be', 'or', 'some', 'that', "'s", 'get', 'with', 'have', 'an', 'from', 'your', 'should', 'if',
               'people', 'like', 'good', 'at', 'there', 'as', 'about', 'would', 'not', 'will', "n't", 'between', 'one',
               'what', 'when', 'most', 'how', 'make', 'way', 'we', 'by', 'did', '"', 'me', 'life', 'any', 'so', 'they',
               'was', 'time', 'this', 'money', 'after', 'know', 'difference', 'learn', 'much', 'use', 'someone',
               'their', 'am', 'think', 'many', 'work', 'why', 'has', 'all', 'than', 'ever', 'more', 'find', 'without',
               'become', 'start', 'who', 'new', 'better', 'other', 'online', 'out', 'first', 'want', 'but', 'mean',
               'job', 'into', 'up', 'feel', 'year', 'take', '2016', 'love', 'possible', 'world', 'which', 'he', 'day',
               'questions', 'things', 'notes', 'ways', 'buy', 'really', 'person', 'phone', 'weight', 'account', 'used',
               '500', 'were', 'long', '1000', 'them', 'go', 'girl', 'could', 'old', "'", "'m", 'her', 'improve',
               'being', 'using', 'his', 'engineering', 'number', 'need', 'books', 'lose', 'stop', 'sex', 'different',
               '2', 'movie', 'been', 'thing', 'business', 'language', 'see', 'book', 'compare', '3', 'free', 'going',
               'just', 'years', 'still', 'question', 'had', 'black', 'programming', 'only', 'happen', 'change', 'no',
               'movies', 'its', 'before', 'help', 'women', 'company', 'prepare', 'over', 'now', 'examples', 'app',
               'real', 'under', 'country', 'back', 'ask', 'website', 'important', '1', 'she', 'while', 'win', 'our',
               'live', 'study', 'bad', 'system', 'same', 'through', 'increase', 'made', 'iPhone', 'learning', 'read',
               'college', 'ca', 'computer', '&', 'data', 'earn', '10', 'two', 'water', 'top', 'during', 'school',
               'student', 'software', 'say', 'card', 'men', 'high', 'car', '5', 'name', 'getting', 'give', 'anyone',
               '4', 'exam', 'mobile', 'word', 'companies', 'energy', 'true', 'average', 'right', 'science', 'days',
               'doing', 'come', 'friend', "'ve", 'laptop', 'then', 'war', '2017', 'hair', 'look', 'where', 'career',
               'home', 'own', 'answer', 'him', 'tell', 'interview', 'even', 'meaning', 'safe', 'government', 'guy',
               'write', 'video', 'travel', 'students', 'done', 'eat', 'off', 'password', 'cost', 'working', 'happens',
               'relationship', 'experience', 'place', 'rid', 'very', 'web', 'watch', 'social', 'having', 'girls',
               'friends', 'food', 'non', 'countries', 'rupee', 'mind', 'favorite', 'man', 'employees', 'major',
               'president', 'affect', 'future', 'human', 'download', 'believe', 'end', 'too', 'tips', 'process',
               'skills', 'exist', 'myself', 'body', 'effects', 'history', 'create', 'against', 'differences', 'next',
               'play', 'email', 'girlfriend', 'makes', 'every', 'places', 'last', 'hard', 'interesting', 'age',
               'making', 'visit', 'service', 'engineer', 'month', 'got', 'test', 'these', 'police', 'class', 'worth',
               'mechanical', 'pay', 'never', 'keep', 'election', 'around', 'bank', 'music', 'each', 'actually',
               'market', 'woman', 'salary', 'marketing', 'support', 'song', 'available', 'control', 'white', 'culture',
               'power', 'considered', 'something', 'fat', 'course', 'always', '6', 'another', 'looking', 'months',
               'apply', 'delete', 'answers', '\xe2\x80\x99s', 'site', 'hotel', 'common', 'writing', 'die', 'economy',
               'parents', 'light', 'universities', '7', 'self', 'series', 'game', 'per', 'happened', 'great', 'today',
               'such', 'deal', 'problem', 'score', 'kind', 'big', 'i', 'behind', 'build', 'able', 'speed', 'open',
               'state', 'idea', 'type', 'purpose', 'living', 'review', 'songs', 'worst', 'well', 'hack', 'development',
               'code', 'period', 'near', 'seen', 'differ', 'reduce', 'wrong', 'cause', 'date', 'reason', 'list',
               'popular', 'asked', 'majors', 'run', 'websites', 'current', 'instead', 'because', 'show', 'height',
               'join', 'easily', 'boyfriend', 'post', 'degree', 'jobs', 'space', 'design', 'sentence', 'hate', 'dark',
               'family', 'facts', 'private', 'biggest', 'games', 'traffic', 'call', 'education', 'stay', 'pregnant',
               'universe', 'sleep', 'earth', 'causes', 'down', 'order', 'based', 'choose', 'apps', 'compared', '2000',
               'sites', 'benefits', "'re", 'less', 'gain', 'public', 'program', 'wear', 'currency', 'services',
               'search', 'small', 'both', 'recover', 'face', 'successful', 'decision', 'move', 'law', 'add', 'terms',
               'remove', 'part', 'videos', 'overcome', 'products', 'startup', 'plan', 'fast', 'dog', 'fall', 'found',
               'humans', 'internet', 'ban', 'main', 'views', 'death', 'value', 'invest', 'child', 'normal', 'legal',
               'banning'}
...
diff_only_location='diff_only_location'

def is_upper_diff(s):
    return len(s)>0 and s[0].isupper() and s.lower() not in upper_stops

def is_diff_only_loc(a,b):

    a = a.split()
    b = b.split()
    u = set(a).union(set(b)).intersection(blja_markers)
    if len(u)>0:
        return 0
    ...
    for i in range(len(a)):
        ...
        if x!=y:
            if is_upper_diff(x) and is_upper_diff(y):
                upper_diff=True
                diff_a.add(x)
                diff_b.add(y)
                continue
    ...
    return 1 if upper_diff else 0

def add_diff_only_location_feature(df):
    df[diff_only_location] = df.apply(lambda s: is_diff_only_loc(s[tokens_q1], s[tokens_q2]), axis=1)


diff_loc_train_fp = os.path.join(data_folder, 'diff_loc', 'diff_loc_train.csv')
diff_loc_test_fp = os.path.join(data_folder, 'diff_loc', 'diff_loc_test.csv')

def write_diff_loc_feature():
    train_df, test_df = load_train_tokens(), load_test_tokens()

    # train_df, test_df = train_df.head(5000), test_df.head(5000)

    add_diff_only_location_feature(train_df)
    train_df[[diff_only_location]].to_csv(diff_loc_train_fp, index_label='id')
    print 'Done Train!'


    add_diff_only_location_feature(test_df)
    test_df[[diff_only_location]].to_csv(diff_loc_test_fp, index_label='test_id')
    print 'Done TEST!'


write_diff_loc_feature()
