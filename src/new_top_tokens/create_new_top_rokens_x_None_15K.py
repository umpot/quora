...
top_15K_x_None_freq_train_fp = os.path.join(data_folder,'top_7K_pairs' ,'top_15K_x_None_freq_train.csv')
top_15K_x_None_freq_test_fp = os.path.join(data_folder,'top_7K_pairs' ,'top_15K_x_None_freq_test.csv')
...
def write_top_N_x_None_freq():
    ...
    train_df[new_cols].to_csv(top_15K_x_None_freq_train_fp, index_label='id')
    print 'Done TRAIN!'
    print '======================================='

    process_top_N_x_None_toks(test_df, m, None)
    test_df[new_cols].to_csv(top_15K_x_None_freq_test_fp, index_label='test_id')
