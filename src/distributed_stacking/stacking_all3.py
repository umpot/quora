...
def load_train_all_xgb():
    train_df = pd.concat([
        ...
        load_pronoun_pairs_50_train(),
        load_new_top_uppers_train(),
        load_top_7K_pair_freq_train(),
        load_top_7K_x_None_freq_train(),
        load_pair_freq_train(),
        load_lstm_train()
    ], axis=1)
...
def load_test_all_xgb():
    test_df = pd.concat([
        ...
        load_pronoun_pairs_50_test(),
        load_new_top_uppers_test(),
        load_top_7K_pair_freq_test(),
        load_top_7K_x_None_freq_test(),
        load_pair_freq_test(),
        load_lstm_test()
    ], axis=1)
...
def perform_xgb_cv(name, mongo_host, f_num):
    seed = 42
